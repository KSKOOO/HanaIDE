...
export const CONFIG_SCHEMA = {
  ...
  'vscodeWorkbench.enabled': { scope: 'global', setter: 'setVscodeWorkbenchEnabled', getter: 'getVscodeWorkbenchEnabled', prefsPath: 'vscode_workbench.enabled', defaultValue: false },
  'vscodeWorkbench.galleryEnabled': { scope: 'global', setter: 'setVscodeWorkbenchGalleryEnabled', getter: 'getVscodeWorkbenchGalleryEnabled', prefsPath: 'vscode_workbench.galleryEnabled', defaultValue: true },
  'vscodeWorkbench.extensionAutoUpdate': { scope: 'global', setter: 'setVscodeWorkbenchExtensionAutoUpdate', getter: 'getVscodeWorkbenchExtensionAutoUpdate', prefsPath: 'vscode_workbench.extensionAutoUpdate', defaultValue: false },
  'vscodeWorkbench.appAutoUpdate': { scope: 'global', setter: 'setVscodeWorkbenchAppAutoUpdate', getter: 'getVscodeWorkbenchAppAutoUpdate', prefsPath: 'vscode_workbench.appAutoUpdate', defaultValue: false },
  'vscodeWorkbench.fallbackToHanaOnFailure': { scope: 'global', setter: 'setVscodeWorkbenchFallbackToHanaOnFailure', getter: 'getVscodeWorkbenchFallbackToHanaOnFailure', prefsPath: 'vscode_workbench.fallbackToHanaOnFailure', defaultValue: true },
