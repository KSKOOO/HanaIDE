...
} from "../memory/compiled-memory-snapshot.ts";
import { normalizePlainDescription } from "../text/internal-narration.ts";
...
function defaultAvatarForYuan(yuan) {
  const fileName = {
    hanako: "hanaide/hanaide-assistant-avatar.png",
    butter: "Butter.png",
    ming: "Ming.png",
    kong: "Kong.png",
  }[yuan] || "hanaide/hanaide-assistant-avatar.png";
