...
import {
  ...
  promptAndCreateSshStudioWorkspace,
...
function FolderPicker({
  ...
  const handleConnectSshWorkspace = useCallback(async () => {
    setShowHistory(false);
    await promptAndCreateSshStudioWorkspace();
  }, []);
    ...
    >
      ...
      {showHistory && (
        <FolderHistory
          ...
          onConnectSshWorkspace={handleConnectSshWorkspace}
...
function FolderHistory({ cwdHistory, agentHomeFolders, selectedFolder, selectedWorkspaceMountId, studioWorkspaces, homeFolder, workspaceFolders, onSelectWorkspace, onSelect, onBrowse, onConnectSshWorkspace, onAddWorkspaceFolder, onRemoveRecentWorkspace, onRemoveStudioWorkspace, onRemoveWorkspaceFolder }: {
  cwdHistory: string[];
  ...
  return (
    <div className={styles.folderHistory}>
      ...
      <div className={styles.folderHistoryBrowse} onClick={(e) => { e.stopPropagation(); onConnectSshWorkspace(); }}>
        <span className={styles.folderHistoryItemIcon}>
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <span>{t('input.connectSshWorkspace')}</span>
      </div>
      <div className={styles.folderHistoryDivider} />
      <div className={styles.folderHistorySectionLabel}>
