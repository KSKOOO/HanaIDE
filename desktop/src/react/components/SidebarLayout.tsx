...
export function SidebarLayout() {
  ...
  useEffect(() => {
    ...
    if (legacy && !localStorage.getItem('hana-sidebar-coding')) {
      localStorage.setItem('hana-sidebar-coding', legacy);
    }
    const savedOpen = localStorage.getItem('hana-sidebar-coding');
